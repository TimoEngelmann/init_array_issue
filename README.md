Disclaimer:
===========
Probably not quite the right place for this bug report. However, since the issue appeared with the update to CubeIDE VSCode 3.8.0 and STM32CubeMX v6.17.0, and the project in the attached ZIP was created with these versions to reproduce the behavior, I am placing it here.
...
Steps to Use the Project in ZIP-File:
=====================================
